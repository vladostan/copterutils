...
def load_velo_scan(file_path):
    """
        ...
        src : https://github.com/utiasSTARS/pykitti/blob/master/pykitti/utils.py
    """
...
def birds_eye_point_cloud(points, side_range = (-10, 10),
                                  fwd_range = (-10,10),
                                  res=0.1,
                                  min_height = -2.73,
                                  max_height = 1.27):
    ...
    """
        src : http://ronny.rest/blog/post_2017_03_26_lidar_birds_eye/
        todo : different lidar formats, gpu acceleration.
    """
    """ 
